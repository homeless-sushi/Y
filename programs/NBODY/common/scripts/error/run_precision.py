...
PROGRAM_URL = os.path.abspath(os.path.join(os.path.dirname(os.path.realpath(__file__)), "../../../ALGORITHM/build/NBODY/NBODY")) # this script directory
...
def setup_args() :
    ...
    parser = argparse.ArgumentParser(
        prog='Run Precision',
        description=
            'This program runs the NBODY algorithm at varying levels of precision'
...
def main() :
    ...
    if max_p <= min_p :
        raise ValueError("ERROR: ILLEGAL ARGUMENT - max precision should be greater than min precision")
